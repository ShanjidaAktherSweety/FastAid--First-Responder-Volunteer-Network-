...
<head>
    ...
    <title>Request Help | FastAid</title>
</head>
<body>
    <div class="main-container">
        <div class="header">
            ...
            <ul class="menu-list">
                ...
                <!-- CHANGED: requestHelp.html -> requestHelp.php -->
                <li><a href="requestHelp.php">Request Help</a></li>
                <li><a href="admin.php">Admin</a></li>
                <!-- CHANGED: patient.html -> patient.php -->
        ...
        <div class="footer">
            ...
            <div class="footer1">
                ...
                <ul class="footer-list">
                    <li><a href="index.html">Home</a></li>
                    <!-- CHANGED: register.html -> register.php -->
                    <li><a href="register.php">Register As Responder</a></li>
                    <li><a href="dashboard.php">Dashboard</a></li>
                </ul>
            </div>
        ...
        <script>
            ...
            // CHANGED: logout now goes to logout.php
            function logout() {
